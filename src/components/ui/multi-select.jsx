...
const MultiSelector = ({
  ...
  return (
    <Command
      ...
      className={cn(
        "h-auto overflow-visible bg-white dark:bg-white/5",
    ...
    >
      ...
      >
        ...
        <ChevronDownIcon
          className={cn(
            "pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 text-muted-foreground transition-transform size-4 opacity-60",
            open && "rotate-180"
          )}
        />
      </div>
