  ...
  return (
    <div>
      ...
      <div className="relative">
        <div className="absolute text-sm font-medium top-1/2 -translate-y-1/2 left-3 text-muted-foreground border-r pr-2 w-8 border-r-foreground">
          {symbol}
        </div>
        <Input
          ref={inputRef}
          ...
          className={cn(
            "mt-0.5 rounded-md border bg-white p-5 px-3 dark:border-[#dcdcdc]/10 dark:bg-white/5 ps-16",
            className
          )}
          {...props}
        />
