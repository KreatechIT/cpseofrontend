...
import MemberRoleCardView from "./MemberRoleCardView";
import MemberRoleTableView from "./MemberRoleTableView";

const MemberRoleFilters = ({ members, memberRoles }) => {
  // UI and Redux state
...
export default MemberRoleFilters;
