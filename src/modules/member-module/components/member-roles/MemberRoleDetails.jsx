...
const MemberRoleDetails = () => {
  ...
  const modules = Object.entries(memberRoleInfo.permissions || {})
    .filter(([_, value]) => typeof value === "boolean")
    .map(([name, enabled]) => ({ name, enabled }));

  const actions = Object.entries(memberRoleInfo.permissions || {})
  ...
  return (
    <div className="-mt-4 pb-4">
      ...
      <div className="relative overflow-scroll mt-2.5 max-h-[500px]">
...
export default MemberRoleDetails;
