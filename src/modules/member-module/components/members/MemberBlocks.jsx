...
export function MemberThreeDotsDropdown({ member, view = "card" }) {
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent side="bottom" align="end">
        ...
        {hasPermission("member.reset") && (
          ...
          >
            <SquareAsteriskIcon size={16} aria-hidden="true" />
...
export function MemberPermissions({ member, view = "card" }) {
  const dispatch = useDispatch();
