    ...
    <div className="space-y-8">
            ...
            {filteredCompetitors.length > 0 ? (
              filteredCompetitors.map((comp, index) => (
                <TableRow key={comp.id}>
                  ...
                  <TableCell>{comp.business_type || "-"}</TableCell>
                  ...
                  <TableCell>
                    {comp.date_start_ranking
                      ? format(new Date(comp.date_start_ranking), "dd MMM yyyy")
                      : "-"}
                  </TableCell>
      ...
      <div className="mt-12">
        <div className="flex items-center justify-between mb-6">
          <Button variant="default" className="bg-[#3872FA] hover:bg-[#3872FA]/90">
            Mind Map
          </Button>
                      ...
                      {subTierData[item.id].map((sub, subIndex) => (
                        <div key={subIndex} className="relative">
                          <div className="border-2 border-[#3872FA] rounded-xl p-5 text-center bg-[#3872FA]/5">
                            ...
                            <div className="text-base font-medium mt-2">{sub.domain}</div>
