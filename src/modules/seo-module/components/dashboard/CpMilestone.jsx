    ...
    <Card className="shadow-none bg-[#FBFCFF1A] hover:bg-[#3872FA1A]" >
      ...
      <CardContent className="">
        <div className="text-start mb-4 flex justify-between">
          <p className="text-xl font-inter font-normal leading-150% tracking-wide">
            Impressions
          </p>
          <p className="font-bold flex gap-2 items-center"><div className="w-3 h-3 rounded-full bg-[#45D871]"></div> {totalImpressions.toLocaleString()}</p>
        </div>
        <div className="text-start mb-4 flex justify-between">
          <p className="text-xl font-inter font-normal leading-150% tracking-wide">Clicks</p>
           <p className="font-bold flex gap-2 items-center"><div className="w-3 h-3 rounded-full bg-[#45D871]"></div>{totalClicks.toLocaleString()}</p>
        </div>
        <div className="text-start mb-4 flex justify-between">
          <p className="text-xl font-inter font-normal leading-150% tracking-wide">Form Inquiries</p>
           <p className="font-bold flex gap-2 items-center"><div className="w-3 h-3 rounded-full bg-[#FF3434]"></div>{totalFormInquiries.toLocaleString()}</p>
        </div>
        <div className="text-start mb-4 flex justify-between">
          <p className="text-xl font-inter font-normal leading-150% tracking-wide">Join / Signups</p>
           <p className="font-bold flex gap-2 items-center"><div className="w-3 h-3 rounded-full bg-[#45D871]"></div>{totalJoins.toLocaleString()}</p>
        </div>
      </CardContent>
    </Card>
  );
