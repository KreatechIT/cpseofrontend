...
import { updateTestScenario } from "../../services/testScenarioService";
import { toast } from "sonner";
import axiosInstance from "@/services/axiosInstance";

const EditTestScenarioForm = ({ scenario, onClose, onSuccess }) => {
  ...
  const [formData, setFormData] = useState({
    created_date: parseDate(scenario.created_date) || new Date(),
    test_scenario: scenario.test_scenario || "",
    project: scenario.project || "",
    sub_project: scenario.sub_project || "",
    unique_domain: scenario.unique_domain || "",
    page_url: scenario.page_url || "",
    hypothesis: scenario.hypothesis || "",
    expected_result: scenario.expected_result || "",
    start_date: parseDate(scenario.start_date),
    found_date: parseDate(scenario.found_date),
    outcome: scenario.outcome || "",
    analysis: scenario.analysis || "",
    result: scenario.result || "",
    conclusion: scenario.conclusion || "",
    next_steps: scenario.next_steps || "",
    implementation_date: parseDate(scenario.implementation_date),
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateTestScenario(scenario.id, payload);
      onSuccess();
      onClose();
    } catch (error) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-h-[70vh] overflow-y-auto px-1">
      <h2 className="text-lg font-semibold sticky top-0 bg-background pb-2">Edit Test Scenario</h2>
...
export default EditTestScenarioForm;
