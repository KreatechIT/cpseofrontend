            ...
            onClick={() =>
              dispatch(
                setDialogData({
                  ...
                  props: { memberRole: memberRole, organisation: organisation },
        ...
        {hasPermission("role.edit") && (
          <DropdownMenuItem
            onClick={() =>
              dispatch(
                setDialogData({
                  type: "editMemberRoleByAdmin",
                  props: { role: memberRole, organisation: organisation },
...
export function MemberRolePermissions({
  memberRole,
  view = "card",
  organisation,
}) {
