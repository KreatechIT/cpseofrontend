...
import { archiveTransactionDescription } from "@/modules/finance-module/services/bankService";

const ArchiveTransactionDescriptionAlert = () => {
  const dispatch = useDispatch();
  const { user } = useSelector((state) => state.auth);
  const description = useSelector((state) => state.dialog.props);
...
export default ArchiveTransactionDescriptionAlert;
